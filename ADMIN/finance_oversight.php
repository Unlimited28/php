...
$stmt = $db->query('SELECT p.*, u.full_name, a.name as association_name, v.full_name as approver_name
                    FROM payments p
...
<head>
    ...
    <title>Finance Oversight - Super Admin</title>
        ...
        <main class="main-content">
            ...
            <header class="main-header">
                <div class="header-left">
                    <h1 class="page-title">Finance Oversight</h1>
                </div>
                        ...
                        <table class="dash-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($payment['approver_name'] ?? '-'); ?></td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
