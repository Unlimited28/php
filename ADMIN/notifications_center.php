...
$stmt = $db->prepare("SELECT * FROM notifications WHERE recipient_type = 'super_admin' OR recipient_type = 'all' ORDER BY created_at DESC");
$stmt->execute();
...
<head>
    ...
    <title>Notification Center - Super Admin</title>
            ...
            <div class="content-wrapper">
                <div class="dash-card">
                    <div class="dash-card-header">
                        <h3>All System Notifications</h3>
                    </div>
