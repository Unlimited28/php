...
<head>
    ...
    <title>Voucher Management - Super Admin</title>
    ...
    <div class="dashboard-layout">
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="voucher-management.php" class="active"><i class="ri-coupon-3-line"></i> Voucher Management</a>
            ...
            <div class="content-wrapper">
                <div class="dash-card">
                    ...
                    <div class="dash-card-content">
                        <p>The Voucher Management module is currently being built. Please check back later.</p>
                    </div>
                </div>
            </div>
        </main>
