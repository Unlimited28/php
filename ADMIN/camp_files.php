...
$stmt = $db->prepare('SELECT cr.*, a.name AS association_name FROM camp_registrations cr JOIN associations a ON cr.association_id = a.id ORDER BY cr.uploaded_at DESC');
$stmt->execute();
$files = $stmt->fetchAll();
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Camp Files - Super Admin</title>
    ...
    <div class="dashboard-layout">
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="camp_files.php" class="active"><i class="ri-file-excel-2-line"></i> Camp Files</a>
        ...
        <main class="main-content">
            ...
            <header class="main-header">
                <div class="header-left">
                    <h1 class="page-title">Camp Registration Files</h1>
                </div>
            ...
            <div class="content-wrapper">
                <div class="dash-card">
                    <div class="dash-card-header">
                        <h3>Uploaded Files from All Associations</h3>
                    </div>
                    <div class="dash-card-content">
                        <table class="dash-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo htmlspecialchars($file['association_name']); ?></td>
                                    <td><?php echo htmlspecialchars(basename($file['file_path'])); ?></td>
                                    <td><?php echo date('Y-m-d', strtotime($file['uploaded_at'])); ?></td>
                                    <td><span class="status status-<?php echo $file['status'] === 'approved' ? 'approved' : 'pending'; ?>"><?php echo ucfirst($file['status']); ?></span></td>
                                    <td><a href="../<?php echo htmlspecialchars($file['file_path']); ?>" class="btn btn-secondary btn-sm" download>Download</a></td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
